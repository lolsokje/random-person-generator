...
namespace LilPecky\RandomPersonGenerator\Providers\ja_JP;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Sota", "Tadao", "Tadashi", "Taiga", "Taisei", "Takahiro", "Takao", "Takashi", "Takaya", "Takayoshi", "Takayuki", "Takeru", "Takeshi", "Takuma", "Takumi", "Takuto", "Taro", "Tatsuhiro", "Tatsuki", "Tatsuya",
        "Tetsuo", "Tetsuya", "Tohru", "Toma", "Tomoya", "Toru", "Toshiaki", "Toshifumi", "Toshihide", "Toshihiko", "Toshihiro", "Toshikazu", "Toshimitsu", "Toshinari", "Toshio", "Wataru", "Yamato", "Yasuhiro", "Yasumasa", "Yasuo",
    ...
    public static array $givenNamesFemale = [
        ...
        "Mai", "Makiko", "Mami", "Mana", "Manami", "Mari", "Mariko", "Masako", "Maya", "Mayumi", "Megumi", "Mei", "Miho", "Miki", "Miku", "Mina", "Minako", "Minami", "Misaki", "Miyabi",
        "Miyako", "Miyu", "Miyuki", "Moe", "Momoko", "Nana", "Nanami", "Nao", "Naoko", "Natsuki", "Natsumi", "Nobuko", "Noriko", "Rei", "Reiko", "Rie", "Rika", "Rina", "Ritsuko", "Rumi",
        "Ruri", "Ryoko", "Sachi", "Sachiko", "Saeko", "Saki", "Sakiko", "Sakura", "Sanae", "Sara", "Satoko", "Sayaka", "Sayoko", "Sayuri", "Seiko", "Setsuko", "Shiori", "Shizuka", "Sumiko", "Tae",
    ...
    public static array $familyNames = [
        ...
        "Hirabayashi", "Hirai", "Hirano", "Hiraoka", "Hirata", "Hirose", "Hirota", "Hokama", "Honda", "Hongo", "Hori", "Horie", "Hosaka", "Hoshino", "Ichikawa", "Ide", "Igarashi", "Iguchi", "Iida", "Iizuka",
        "Ikeda", "Imai", "Imamura", "Inaba", "Inoue", "Irie", "Ishibashi", "Ishida", "Ishihara", "Ishikawa", "Ishimoto", "Ishizaki", "Ito", "Iwamoto", "Iwasaki", "Izumi", "Jinno", "Jo", "Kadokawa", "Kadowaki",
        "Kai", "Kaifu", "Kajiwara", "Kakinuma", "Kameda", "Kamiya", "Kanai", "Kaneko", "Kanematsu"
    ];
}
