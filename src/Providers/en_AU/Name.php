...
namespace LilPecky\RandomPersonGenerator\Providers\en_AU;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Jackson", "Jacob", "Jake", "James", "Jasper", "Jayden", "Jett", "Joel", "John", "Jordan", "Joseph", "Joshua", "Jude", "Julian", "Kai", "Kane", "Kieran", "Kingston", "Kobe", "Kody",
        "Lachlan", "Leo", "Leon", "Levi", "Lewis", "Liam", "Lincoln", "Logan", "Lucas", "Luke", "Maddox", "Malcolm", "Marcus", "Mason", "Max", "Maxwell", "Michael", "Miles", "Mitchell", "Nash",
        "Nate", "Nathan", "Nicholas", "Noah", "Oliver", "Oscar", "Owen", "Patrick", "Paul", "Peter", "Phoenix", "Rhys", "Riley", "Robert", "Rory", "Ryan", "Samuel", "Sebastian", "Seth", "Shane",
    ...
    public static array $givenNamesFemale = [
        ...
        "Penelope", "Philippa", "Pippa", "Primrose", "Queenie", "Quiana", "Quincy", "Quinn", "Rhiannon", "Rosalie", "Rosalind", "Rowena", "Samantha", "Sasha", "Scarlett", "Sienna", "Tahlia", "Tara", "Tessa", "Thalia",
        "Uma", "Una", "Unaiza", "Ursula", "Veronica", "Victoria", "Violet", "Vivienne", "Wendy", "Willow", "Winifred", "Winona", "Xanthe", "Ximena", "Xyla", "Yara", "Yasmin", "Ysabel", "Yvette", "Zahara",
        "Zaina", "Zara", "Zoe"
    ];
    ...
    public static array $familyNames = [
        ...
        "Quinn", "Reid", "Robertson", "Ross", "Ryan", "Scott", "Simpson", "Stevens", "Sutherland", "Taylor", "Thomas", "Thompson", "Turner", "Underhill", "Underwood", "Upton", "Valentine", "Vance", "Vasquez", "Vega",
        "Watson", "Williams", "Wilson", "Wright", "Xander", "Xiao", "Xiong", "Xu", "Yates", "Yee", "Young", "Zane", "Zhang", "Ziegler", "Zimmerman"
    ];
}
