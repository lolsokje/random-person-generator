...
namespace LilPecky\RandomPersonGenerator\Providers\th_TH;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Kritchapol", "Kritsada", "Krittin", "Kulapat", "Lakkhana", "Lalita", "Manas", "Manit", "Monthien", "Nanthaphong", "Napat", "Natthapong", "Natthawut", "Nipat", "Niphon", "Nipon", "Nirut", "Nithi", "Nithikul", "Nithinon",
        "Nithipat", "Nithipol", "Nithithorn", "Nithiwat", "Nophadol", "Noppadol", "Noppakun", "Nopparat", "Nopphon", "Noraphat", "Nuttapol", "Nuttawut", "Orathai", "Pakorn", "Pakpoom", "Panupan", "Panupong", "Pariwat", "Parn", "Pattanapong",
        "Pattharaphol", "Pattharapol", "Pattharapong", "Patthawit", "Patthawut", "Pawat", "Phanom", "Phanuphong", "Phanupong", "Phanuwat", "Phetcharat", "Phichet", "Phitak", "Phithan", "Phongphat", "Phongsak", "Phongsathon", "Phongsathorn", "Phongthep", "Phumin",
    ...
    public static array $givenNamesFemale = [
        ...
        "Kittichai", "Kittiya", "Krisana", "Kulap", "Kultida", "Kunlanit", "Kwanta", "Ladda", "Laksana", "Lalita", "Lamai", "Lampai", "Lamyong", "Lanna", "Lek", "Likit", "Lilavadee", "Lilawadee", "Lukchai", "Malee",
        "Malinee", "Maneerat", "Manirat", "Manopa", "Mantana", "Mayuree", "Meena", "Mongkhol", "Mookda", "Naiyana", "Napat", "Napatsorn", "Naree", "Narin", "Narisa", "Narong", "Nat", "Natcha", "Nattaya", "Nid",
        "Nim", "Nimit", "Nipa", "Nipon", "Nisa", "Nisarat", "Niti", "Nitima", "Nitsa", "Noi", "Nongluck", "Nualchan", "Nuanjan", "Nuanthip", "Nuchanart", "Nucharee", "Nuchuda", "Nuengruethai", "Nuttida", "Orapan",
    ...
    public static array $familyNames = [
        ...
        "Pitakdumrong", "Pitaksanurat", "Piyasirisorost", "Pornpipat", "Pornpratang", "Pornthep", "Praphasirirak", "Prasitthipong", "Preecha", "Pukchai", "Pummarin", "Sarikaputra", "Sawadisavi", "Sawangsuk", "Sawatwong", "Sintusiri", "Sombatsiri", "Songkham", "Srijariya", "Srikul",
        "Srimuang", "Sripanich", "Srisawat", "Srisook", "Sriwan", "Suebsakul", "Suphachai", "Sutthiphong", "Sutthirat", "Thabthong", "Thammasit", "Thamsatchanan", "Thanakornkul", "Thansanee", "Thepthong", "Thongthep", "Tirawat", "Tumwattana", "Tupananchai", "Uamcharoen",
        "Wongsawat", "Yodkwan"
    ];
}
