...
namespace LilPecky\RandomPersonGenerator\Providers\zh_CN;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Le", "Lei", "Li", "Liang", "Liao", "Lie", "Lin", "Ling", "Liu", "Long", "Lu", "Luo", "Lv", "Mao", "Ming", "Nan", "Ning", "Pei", "Peng", "Qi",
        "Qian", "Qiang", "Qin", "Qing", "Qiu", "Qu", "Ren", "Rong", "Ru", "Rui", "Run", "Sen", "Shan", "Shen", "Sheng", "Shi", "Shou", "Shu", "Shun", "Si",
        "Song", "Su", "Tai", "Tao", "Teng", "Ti", "Tian", "Tie", "Tong", "Wei", "Wen", "Wu", "Xi", "Xia", "Xian", "Xiao", "Xie", "Xin", "Xing", "Xiong",
        "Xiu", "Xu", "Xue", "Ya", "Yang", "Yi", "Yin", "Ying", "Yo", "Yong", "You", "Yu", "Yuan", "Yue", "Yun", "Zeng", "Zhan", "Zhang", "Zhao", "Zhen",
    ...
    public static array $givenNamesFemale = [
        ...
        "Ming", "Na", "Nan", "Ning", "Nu", "Ou", "Pei", "Ping", "Qi", "Qian", "Qiao", "Qin", "Qing", "Qiong", "Qiu", "Rong", "Ru", "Rui", "Sa", "Shan",
        "Shu", "Si", "Su", "Suyin", "Tang", "Tao", "Tian", "Ting", "Tong", "Wei", "Wen", "Wu", "Xi", "Xia", "Xiang", "Xiao", "Xin", "Xing", "Xiu", "Xue",
    ...
    public static array $familyNames = [
        ...
        "Shang", "Shao", "Shen", "Shi", "Shuai", "Song", "Su", "Sun", "Tang", "Tao", "Tian", "Wang", "Wei", "Wen", "Wu", "Xia", "Xiang", "Xiao", "Xie", "Xing",
        "Xiong", "Xu", "Xuan", "Xue", "Yan", "Yang", "Yao", "Ye", "Yin", "Yu", "Yuan", "Yue", "Zeng", "Zhan", "Zhang", "Zhao", "Zheng", "Zhi", "Zhong", "Zhou",
        "Zhu", "Zhuang", "Zhuo", "Zi", "Zou", "Zuo"
    ];
}
