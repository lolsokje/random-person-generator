...
namespace LilPecky\RandomPersonGenerator\Providers\ms_MY;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    ...
    public static array $givenNamesFemale = [
        ...
        "Kareena", "Kathleen", "Khadijah", "Khalida", "Khansa", "Kiara", "Kiera", "Kristen", "Laila", "Lara", "Laura", "Lena", "Liana", "Lila", "Liliana", "Lina", "Linda", "Liyana", "Maggie", "Mai",
        "Malia", "Marina", "Marissa", "Marsya", "Maryam", "Maya", "Medina", "Megan", "Melissa", "Mia", "Michelle", "Mila", "Misha", "Muna", "Nadia", "Nadira", "Nadya", "Nurin", "Nurul", "Nurulain",
        "Olivia", "Pavitra", "Puteri", "Qistina", "Raihana", "Rania", "Raniah", "Raqibah", "Rashidah", "Ratna", "Rayhana", "Rayna", "Reena", "Safiyah", "Sakinah", "Salsabila", "Samantha", "Sara", "Sarah", "Sasha",
    ...
    public static array $familyNames = [
        ...
        "Rahman", "Raja", "Ramasamy", "Rashid", "Rosli", "Salleh", "Samad", "Samsudin", "Sani", "Saravanan", "Seow", "Shahrul", "Sim", "Soo", "Sulaiman", "Suleiman", "Tan", "Tay", "Teo", "Tham",
        "Thong", "Toh", "Wan", "Wong", "Wu", "Yahya", "Yap", "Yeo", "Yeoh", "Yew", "Yong", "Yusof", "Zain", "Zainal", "Zakaria", "Zulkifli"
    ];
}
