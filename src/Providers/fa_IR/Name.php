...
namespace LilPecky\RandomPersonGenerator\Providers\fa_IR;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Omid", "Parham", "Parviz", "Payam", "Peyman", "Pouya", "Ramin", "Rasoul", "Reza", "Roozbeh", "Saeed", "Saman", "Sasan", "Sattar", "Sepand", "Shahab", "Shahin", "Shayan", "Shervin", "Siamak",
    ...
    public static array $givenNamesFemale = [
        ...
        "Narges", "Nasim", "Nazanin", "Neda", "Negar", "Nika", "Niloofar", "Niloufar", "Noushin", "Omid", "Parastoo", "Parisa", "Parivash", "Parnaz", "Parvaneh", "Peyvand", "Pooneh", "Raha", "Rahil", "Rana",
        "Razieh", "Roksana", "Roza", "Saba", "Sahar", "Sara", "Sarina", "Sepideh", "Setareh", "Shabnam", "Shadi", "Shaghayegh", "Shahdokht", "Shahrzad", "Shakiba", "Shams", "Shayan", "Shideh", "Shima", "Shirin",
    ...
    public static array $familyNames = [
        ...
        "Nikfarjam", "Nikpour", "Nikseresht", "Nouri", "Omidi", "Parsa", "Pirzadeh", "Qasemi", "Rahimi", "Rajabi", "Rashidi", "Razavi", "Rostami", "Saberi", "Sadeghi", "Safdari", "Salehi", "Salimi", "Samadi", "Sarraf",
        "Sattari", "Sedighi", "Seyedzadeh", "Shahbazi", "Shahidi", "Sharifi", "Shojaei", "Sobhani", "Soleimani", "Tabatabaei", "Tavakoli", "Zadeh", "Zandi", "Zare", "Zarrin", "Ziaei", "Zolfaghari", "Zomorodi"
    ];
}
