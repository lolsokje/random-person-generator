...
namespace LilPecky\RandomPersonGenerator\Providers\ar_JO;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Muhannad", "Mujahid", "Munir", "Mustafa", "Mutaz", "Nabeel", "Nabil", "Nader", "Nael", "Naim", "Najib", "Nasser", "Nidal", "Nizar", "Omar", "Osama", "Qasim", "Qusai", "Ra'fat", "Ra'if",
        "Rabee", "Rafat", "Rahim", "Ramadan", "Rami", "Rasheed", "Riad", "Ridha", "Riyad", "Rizq", "Sabri", "Saddek", "Saeed", "Salah", "Saleem", "Saleh", "Salim", "Samer", "Sami", "Samir",
        "Sayf", "Shadi", "Sharif", "Sulaiman", "Suleiman", "Taha", "Talal", "Tarek", "Tariq", "Tawfiq", "Thaer", "Thamer", "Umar", "Waddah", "Wael", "Walid", "Yahya", "Yaser", "Yassin", "Yazan",
    ...
    public static array $givenNamesFemale = [
        ...
        "Intisar", "Jinan", "Kawthar", "Khadija", "Laila", "Lama", "Lamia", "Leena", "Lubna", "Madiha", "Maha", "Maher", "Mahmouda", "Majd", "Majida", "Malak", "Manal", "Maram", "Mariam", "Marwa",
        "Maysa", "Maysoon", "Mayyada", "Mervat", "Mina", "Mira", "Muna", "Munira", "Nabila", "Nada", "Nadia", "Nadine", "Najah", "Najla", "Nawal", "Nihal", "Nisreen", "Noor", "Nora", "Ola",
        "Omnia", "Rabab", "Rabiha", "Raeda", "Rahaf", "Rana", "Rania", "Rawan", "Reem", "Riham", "Rim", "Ruba", "Rula", "Saba", "Sabah", "Sahar", "Salma", "Samah", "Samia", "Sana",
    ...
    public static array $familyNames = [
        ...
        "Bataineh", "Battah", "Battikhi", "Bdour", "Bitar", "Blan", "Bokhary", "Bqaeen", "Buhairi", "Bukhari", "Dabbas", "Dabbour", "Daboubi", "Daher", "Dahhan", "Dajani", "Dalaeen", "Dalou", "Damiri", "Damis",
        "Dmour", "Dosari", "Doulati", "Dweik", "Ebbini", "Edwan", "Eitan", "Essa", "Esso", "Faouri", "Far", "Faraj", "Fares", "Farhan", "Farouqi", "Farraj", "Fataftah", "Fatlawi", "Fayez", "Fayomi",
        "Fayyad", "Fazaa"
    ];
}
