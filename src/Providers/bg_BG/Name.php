...
namespace LilPecky\RandomPersonGenerator\Providers\bg_BG;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Toma", "Valentin", "Valeri", "Valery", "Vasil", "Vasko", "Velin", "Ventsislav", "Ventzislav", "Veselin", "Viktor", "Vladimir", "Yan", "Yanko", "Yavor", "Yoan", "Yordan", "Yordanov", "Yulian", "Yuliyan",
    ...
    public static array $givenNamesFemale = [
        ...
        "Lidiya", "Liliana", "Liliya", "Lora", "Lubomira", "Lydia", "Lyubena", "Lyubomira", "Magdalena", "Margarita", "Mariela", "Marija", "Mariya", "Maya", "Mila", "Milena", "Mira", "Miriana", "Miroslava", "Monika",
        "Nadejda", "Nadia", "Natalia", "Natasha", "Neda", "Nevena", "Nikolina", "Nina", "Ognyana", "Olga", "Pavlina", "Penka", "Petja", "Petya", "Plamena", "Polina", "Rada", "Radoslava", "Radostina", "Raina",
        "Ralitsa", "Reneta", "Rositsa", "Rumyana", "Sanya", "Sara", "Sashka", "Sevdalina", "Siana", "Silvana", "Simona", "Snejana", "Sofia", "Sofiya", "Stanka", "Stela", "Stiliana", "Stoyanka", "Svetla", "Svetlana",
    ...
    public static array $familyNames = [
        ...
        "Petrov", "Peychev", "Popov", "Radev", "Radkov", "Rangelov", "Rusev", "Savov", "Shishkov", "Slavov", "Sotirov", "Stamenov", "Stanev", "Stefanov", "Stoev", "Stoyanov", "Tanev", "Todorov", "Tonev", "Topalov",
        "Toshev", "Tsvetanov", "Tsvetkov", "Vasilev", "Velichkov", "Venkov", "Videnov", "Vladimirov", "Yanev", "Yankov", "Yordanov", "Yosifov", "Zahariev", "Zarkov", "Zdravkov", "Zhelev", "Zhelyazkov", "Zlatanov", "Zlatev", "Zvezdev",
        "Zyumbyulev"
    ];
}
