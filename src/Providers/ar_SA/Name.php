...
namespace LilPecky\RandomPersonGenerator\Providers\ar_SA;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Othman", "Qassim", "Qusay", "Radhi", "Raid", "Rakan", "Rami", "Ramzi", "Riyad", "Saad", "Saeed", "Saif", "Saleh", "Salem", "Salman", "Samer", "Samir", "Sari", "Saud", "Shadi",
    ...
    public static array $givenNamesFemale = [
        ...
        "Reem", "Reema", "Rihab", "Rima", "Roqaya", "Ruba", "Ruqayyah", "Sabah", "Sabreen", "Sadeem", "Safia", "Sahar", "Saida", "Salma", "Samar", "Sameera", "Samia", "Sana", "Sara", "Sawsan",
        "Shaden", "Shaima", "Shatha", "Shayma", "Soad", "Sultana", "Sumaya", "Sumayah", "Tahani", "Thuraya", "Wafa", "Warda", "Wijdan", "Yara", "Yusra", "Zahra", "Zainab", "Zakiyah", "Zeinah", "Zinah",
        "Zohra", "Zuhra"
    ];
    ...
    public static array $familyNames = [
        ...
        "Alnassar", "Aloqab", "Alqahtani", "Alrabiah", "Alramadhan", "Alrasheed", "Alruwaili", "Alsaleh", "Alsaud", "Alshahrani", "Alshamrani", "Alshehri", "Alsheikh", "Alsulaiman", "Alsuwaidi", "Althobaiti", "Alturki", "Alzahrani", "Alzamel", "Alzamil",
        "Arab", "Assiri", "Awaji", "Bakr", "Daham", "Fahd", "Ghazi", "Ghazzawi", "Haddad", "Hadi", "Hakami", "Hamad", "Hashem", "Ibrahim", "Idris", "Jabri", "Jahdali", "Jamaan", "Jawad", "Khalid",
        "Khoja", "Majed", "Malik", "Marzouq", "Masoud", "Matar", "Mazroui", "Mehanna", "Mohammed", "Musa", "Mutlaq", "Nasrallah", "Nasser", "Qahtani", "Qassim", "Rasheed", "Saeed"
    ];
}
