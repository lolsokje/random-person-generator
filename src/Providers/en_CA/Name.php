...
namespace LilPecky\RandomPersonGenerator\Providers\en_CA;
...
class Name extends \LilPecky\RandomPersonGenerator\Providers\Name
{
    public static array $givenNamesMale = [
        ...
        "Parker", "Patrick", "Philip", "Preston", "Quentin", "Quincy", "Quinn", "Quinton", "Riley", "Rowan", "Ryan", "Rylan", "Samuel", "Sawyer", "Sebastian", "Seth", "Theodore", "Thomas", "Toby", "Tristan",
        "Ulysses", "Umar", "Uriah", "Uriel", "Vance", "Victor", "Viktor", "Vincent", "Walter", "Wesley", "William", "Wyatt", "Xander", "Xavier", "Xeno", "Xerxes", "Yanis", "Yannick", "Yosef", "Yuri",
    ...
    public static array $givenNamesFemale = [
        ...
        "Paige", "Penelope", "Peyton", "Phoebe", "Qiana", "Quincy", "Quinlan", "Quinn", "Rachael", "Rebecca", "Riley", "Rose", "Samantha", "Sarah", "Savannah", "Sophie", "Taylor", "Tessa", "Tiffany", "Trinity",
        "Uma", "Una", "Ursula", "Vanessa", "Victoria", "Violet", "Vivian", "Whitney", "Willa", "Willow", "Xandra", "Ximena", "Xyla", "Yasmin", "Ysabel", "Yvette", "Yvonne", "Zara", "Zelda", "Zinnia",
        "Zoe"
    ];
    ...
    public static array $familyNames = [
        ...
        "Patel", "Petersen", "Phillips", "Quinn", "Reid", "Robinson", "Rogers", "Ross", "Scott", "Simpson", "Smith", "Stewart", "Taylor", "Thompson", "Tran", "Turner", "Underwood", "Upshaw", "Upton", "Usher",
        "Vargas", "Vasquez", "Villeneuve", "Vuong", "Wagner", "Williams", "Wong", "Wright", "Xu", "Yates", "Yee", "Yip", "Young", "Zhang", "Ziegler", "Zimmerman"
    ];
}
